(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-l10n"] = factory();
	else
		root["vue-l10n"] = factory();
...
function extend(Vue) {
  ...
  Vue.prototype.$uts = function (usdAmount) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.ROUNDING;
    var utsExchangeRate = l10nCurrency.currency.utsExchangeRate;
    var symbolDisplay = l10nCurrency.currency.symbolDisplay;
    var symbolPosition = l10nCurrency.currency.symbolPosition;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
    var thousandSeparator = l10nCurrency.currency.thousandSeparator;
  ...
  Vue.prototype.$utsc = function (usdAmount) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.CARRY;
    var utsExchangeRate = l10nCurrency.currency.utsExchangeRate;
    var symbolDisplay = l10nCurrency.currency.symbolDisplay;
    var symbolPosition = l10nCurrency.currency.symbolPosition;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
  ...
  Vue.prototype.$utst = function (usdAmount) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.TRUNCATION;
    var utsExchangeRate = l10nCurrency.currency.utsExchangeRate;
    var symbolDisplay = l10nCurrency.currency.symbolDisplay;
    var symbolPosition = l10nCurrency.currency.symbolPosition;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
  ...
  Vue.prototype.$utsu = function (usdAmount) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.ROUNDUP;
    var utsExchangeRate = l10nCurrency.currency.utsExchangeRate;
    var symbolDisplay = l10nCurrency.currency.symbolDisplay;
    var symbolPosition = l10nCurrency.currency.symbolPosition;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
  ...
  Vue.prototype.$utsd = function (usdAmount) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.ROUNDDOWN;
    var utsExchangeRate = l10nCurrency.currency.utsExchangeRate;
    var symbolDisplay = l10nCurrency.currency.symbolDisplay;
    var symbolPosition = l10nCurrency.currency.symbolPosition;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
  ...
  Vue.prototype.$stu = function (selfAmount) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.ROUNDING;
    var stuExchangeRate = l10nCurrency.currency.stuExchangeRate;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
    var thousandSeparator = l10nCurrency.currency.thousandSeparator;
  ...
  Vue.prototype.$stuo = function (selfAmount) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.ORIGINAL;
    var stuExchangeRate = l10nCurrency.currency.stuExchangeRate;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
    var thousandSeparator = l10nCurrency.currency.thousandSeparator;
    return l10nCurrency._stu(selfAmount, computeType, stuExchangeRate, decimalSymbol, thousandSeparator);
  ...
  */
  ...
  Vue.prototype.$textUtsi = function (usdText) {
    var l10nCurrency = this.$l10nCurrency;
    var computeType = l10nCurrency._computeTypeEnum.INT;
    var utsExchangeRate = l10nCurrency.currency.utsExchangeRate;
    var symbolDisplay = l10nCurrency.currency.symbolDisplay;
    var symbolPosition = l10nCurrency.currency.symbolPosition;
    var decimalSymbol = l10nCurrency.currency.decimalSymbol;
...
var src_VueL10nCurrency = (_temp = _class =
/*#__PURE__*/
function () {
  function VueL10nCurrency(options) {
    _classCallCheck(this, VueL10nCurrency);

    _defineProperty(this, "_computeTypeEnum", {
      ROUNDING: 'rounding',
      // 保留两位小数，四舍五入
      CARRY: 'carry',
      // 保留两位小数，后面有值就进位
    ...
    _defineProperty(this, "_vm", void 0);

    _defineProperty(this, "_root", void 0);

    _defineProperty(this, "_dataListeners", void 0);

    if (!Vue && typeof window !== 'undefined' && window.Vue) {
      install(window.Vue);
    }

    var isoCode = options.isoCode || 'USD';
    var stuExchangeRate = options.stuExchangeRate || '1';
    var utsExchangeRate = options.utsExchangeRate || '1';
    var symbolDisplay = options.symbolDisplay || '$';
    var symbolPosition = options.symbolPosition || 0;
    var decimalSymbol = options.decimalSymbol || '.';
    var thousandSeparator = options.thousandSeparator || '';
    var currency = {
      isoCode: isoCode,
      stuExchangeRate: stuExchangeRate,
      utsExchangeRate: utsExchangeRate,
  ...
  _createClass(VueL10nCurrency, [{
    ...
    key: "destroyVM",
    value: function destroyVM() {
      this._vm.$destroy();
    }
  }, {
    key: "subscribeDataChanging",
    value: function subscribeDataChanging(vm) {
      this._dataListeners.push(vm);
    }
  }, {
    key: "unsubscribeDataChanging",
    value: function unsubscribeDataChanging(vm) {
      var arr = this._dataListeners;

      if (arr.length) {
        var index = arr.indexOf(vm);
    ...
    key: "watchL10nCurrencyData",
    value: function watchL10nCurrencyData() {
      var self = this;
    ...
    value: function watchCurrency() {
      ...
      var target = this._vm;
      return this._root.$l10nCurrency.vm.$watch('currency', function (val) {
    ...
    key: "_formatAmount",
    value: function _formatAmount(amount, computeType, decimalSymbol, thousandSeparator) {
    ...
    key: "_uts",
    value: function _uts(usdAmount, computeType, usdToSelfExchangeRate, symbolDisplay, symbolPosition, decimalSymbol, thousandSeparator) {
      var selfAmount = usdAmount * usdToSelfExchangeRate;

      var formatAmount = this._formatAmount(selfAmount, computeType, decimalSymbol, thousandSeparator);

      return symbolPosition ? formatAmount + symbolDisplay : symbolDisplay + formatAmount;
    }
  }, {
    key: "_stu",
    value: function _stu(selfAmount, computeType, SelfToUsdExchangeRate, decimalSymbol, thousandSeparator) {
      var usdAmount = selfAmount * SelfToUsdExchangeRate;

      var formatAmount = this._formatAmount(usdAmount, computeType, decimalSymbol, thousandSeparator);

      return formatAmount;
    }
  }, {
    key: "_textUts",
    value: function _textUts(usdText, computeType, usdToSelfExchangeRate, symbolDisplay, symbolPosition, decimalSymbol, thousandSeparator) {
      // console.log('[vue-l10n-currency] _textUts.')
      var selfText = usdText;
      var l10n = this;

      if (typeof usdText === 'string' && usdText !== '') {
        if (usdText.includes('$')) {
          var reg = /(\$\d*(\.\d*|\d*))/g;
          var replaceTxt = usdText.replace(reg, function (value) {
            var usdAmount = value.slice(1);
            var selfAmount = usdAmount * usdToSelfExchangeRate;

            var formatAmount = l10n._formatAmount(selfAmount, computeType, decimalSymbol, thousandSeparator);
  ...
  return VueL10nCurrency;
}(), _defineProperty(_class, "install", void 0), _defineProperty(_class, "version", void 0), _temp);
src_VueL10nCurrency.install = install;
src_VueL10nCurrency.version = '1.0.2';
/* harmony default export */ var src = (src_VueL10nCurrency);
...
//# sourceMappingURL=vue-l10n.umd.js.map