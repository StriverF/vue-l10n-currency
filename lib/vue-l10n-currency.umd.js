(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-l10n-currency"] = factory();
	else
		root["vue-l10n-currency"] = factory();
...
function () {
  ...
  _createClass(VueL10nCurrency, [{
    ...
    key: "_uts",
    value: function _uts(usdAmount, computeType, usdToSelfExchangeRate, symbolDisplay) {
      console.log('[vue-l10n-currency] _uts.');
      var selfAmount = usdAmount * usdToSelfExchangeRate;

      var formatAmount = this._formatAmount(selfAmount, computeType);
    ...
    value: function _stu(selfAmount, computeType, SelfToUsdExchangeRate) {
      ...
      var formatAmount = this._formatAmount(usdAmount, computeType);

      return formatAmount;
    }
  }, {
    key: "_textUts",
    value: function _textUts(usdText, computeType, usdToSelfExchangeRate, symbolDisplay) {
      ...
      if (typeof usdText === 'string' && usdText !== '') {
        if (usdText.includes('$')) {
          ...
          var replaceTxt = usdText.replace(reg, function (value) {
            ...
            var formatAmount = l10n._formatAmount(selfAmount, computeType);
...
src_VueL10nCurrency.version = '1.0.1';
...
//# sourceMappingURL=vue-l10n-currency.umd.js.map